  ...
  background-size: cover;
	...
	<body>
		<div clas="container">
			...
			<div class="row mt-3">
				<div class="col d-flex justify-content-center">
					<spring:url value="/ecommerce/mycart/save" var="myCartURL" />
...
<!-- 									<th align="center">Description</th> -->
							...
							<tbody>
								<c:forEach items="${productList.products}" var="product" varStatus="status">
									<tr scope="row">
										<td align="center"><input name="products[${status.index}].productName" value="${product.productId}" readonly="true" /></td>
...
<%-- 										<td align="center"><input name="product.description" value="${products.description}" readonly="true" /></td> --%>
										...
										<td align="center"><input name="products[${status.index}].stock" value="${product.stock}" readonly="true"/></td>
										<td align="center"><input name="products[${status.index}].quantity" value="0"/></td>
...
<!-- 							<input class="btn btn-primary" type="submit" value="Add to cart"> -->
							<spring:url value="/ecommerce/mycart" var="cart" />
